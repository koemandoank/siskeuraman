  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-4 pt-6">
      ...
      <div className="border-border rounded-lg border p-4">
        <h2 className="mb-3 font-semibold">Tambah Pengeluaran</h2>
        <form action={createTransaction} className="space-y-3">
          ...
          <button
            type="submit"
            className="bg-red-600 text-primary-foreground hover:bg-red-700 inline-flex h-9 items-center rounded-md px-4 text-sm font-medium"
          >
            Simpan
          </button>
        </form>
